...
/**
 * Builds necessary hardcoded challenge requests based on develop Object. Example context:
 * {
 *      token: 'abc',
 *      ldap: 'micortes',
 *      initiative: 'ted',
...
/**
 * Builds necessary user challenges requests based on develop Object. Example context:
 * {
 *      token: 'abc',
 *      ldap: 'micortes',
 *      initiative: 'ted',
...
/**
 * Builds necessary backoffice challenges requests based on develop Object. Example context:
 * {
 *      token: 'abc',
 *      ldap: 'micortes',
 *      initiative: 'ted',
 ...
 * @return {Object}
 */
 export const buildBackofficeChallenges = (context) => {
    context.backofficeChallenges = {
        ...buildBackofficeLegallyAuthorized(context),
    };
    return context;
};
...
const buildBackofficeLegallyAuthorized = (context) => ({
    backoffice_legally_authorized: {
        user_id: null, // This is set dynamically
